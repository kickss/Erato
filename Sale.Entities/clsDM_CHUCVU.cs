...
{
    public class clsDM_CHUCVU
    {
        private const string SP_DM_CHUCVU = "sp_DM_CHUCVU";
        ...
        private string mvarMACHUCVU;
        private string mvarTENCHUCVU;
        ...
        {
            get { return mvarMACHUCVU; }
            set { mvarMACHUCVU = value; }
        }

        public string TENCHUCVU
        {
            get { return mvarTENCHUCVU; }
            set { mvarTENCHUCVU = value; }
        }
        ...
        public clsDM_CHUCVU(DataAccess mdal)
        {
            m_DAL = mdal;
            Reset();
        }

        public clsDM_CHUCVU(string mLanguage_Id, Int32 mUser_Id)
        {
            Reset();
        ...
        public clsDM_CHUCVU(DataAccess mdal, string mLanguage_Id, Int32 mUser_Id)
        {
            Reset();
            mvarLANGUAGEID = mLanguage_Id;
            USERID = mUser_Id;
        ...
        public bool Add()
        {
            ...
            try
            {
                ...
                DAL.Parameters.Add(new ParamStruct("@CHUCVU_ID", DbType.Int32, clsCommon.GetValueDBNull(mvarCHUCVU_ID), ParameterDirection.InputOutput, 4));
                DAL.Parameters.Add(new ParamStruct("@MACHUCVU", DbType.String, clsCommon.GetValueDBNull(mvarMACHUCVU), ParameterDirection.Input, 1000));
                DAL.Parameters.Add(new ParamStruct("@TENCHUCVU", DbType.String, clsCommon.GetValueDBNull(mvarTENCHUCVU), ParameterDirection.Input, 1000));
                ...
                mvarCHUCVU_ID = Int32.Parse(clsCommon.GetValue(DAL.Parameters.Items("@CHUCVU_ID").Value, mvarCHUCVU_ID.GetType().FullName).ToString());

                return (mvarCHUCVU_ID > 0);
            }
            catch (Exception ex)
            {
                return false;
        ...
        public bool Delete(int CHUCVU_ID)
        {
            DataAccess DAL = m_DAL;
            try
            {
                ...
                DAL.Parameters.Add(new ParamStruct("@USERID", DbType.Int32, clsCommon.GetValueDBNull(mvarUSERID), ParameterDirection.Input, 4));
                DAL.Parameters.Add(new ParamStruct("@FREEPARA", DbType.String, clsCommon.GetValueDBNull(mvarFREEPARA), ParameterDirection.InputOutput, 1000));
                DAL.Parameters.Add(new ParamStruct("@CHUCVU_ID", DbType.Int32, clsCommon.GetValueDBNull(CHUCVU_ID), ParameterDirection.InputOutput, 4));
                return (DAL.ExecNonQuery() > 0);
            }
            catch (Exception ex)
            {
        ...
        public bool GetByKey(int CHUCVU_ID)
        {
            DataAccess DAL = m_DAL;
            try
            {
        ...
        public void FillData(DataRow row)
        {
            ...
            mvarMACHUCVU = clsCommon.GetValue(row["MACHUCVU"], mvarMACHUCVU.GetType().FullName).ToString();
            mvarTENCHUCVU = clsCommon.GetValue(row["TENCHUCVU"], mvarTENCHUCVU.GetType().FullName).ToString();
        ...
        public DataTable Get_ChucVu_By_Code(int CHUCVU_ID)
        {
            DataAccess DAL = m_DAL;
            try
            {
                ...
                DAL.Parameters.Add(new ParamStruct("@CHUCVU_ID", DbType.Int32, UTILITIES.clsCommon.GetValueDBNull(CHUCVU_ID), ParameterDirection.InputOutput, 4));
                ds = DAL.ExecDataSet();
                return ds.Tables[0];
