...
namespace Sale.Entities
{
    public class clsDM_TINHTHANH
    {
        ...
        private Int32 mvarTINHTHANH_ID;
        private string mvarTINHTHANH_NAME;
        private string mvarTINHTHANH_TYPE;
        ...
        public Int32 TINHTHANH_ID
        {
            get { return mvarTINHTHANH_ID; }
            set { mvarTINHTHANH_ID = value; }
        }

        public string TINHTHANH_NAME
        {
            get { return mvarTINHTHANH_NAME; }
            set { mvarTINHTHANH_NAME = value; }
        }

        public string TINHTHANH_TYPE
        {
            get { return mvarTINHTHANH_TYPE; }
            set { mvarTINHTHANH_TYPE = value; }
        }
        ...
        public bool Add()
        {
            ...
            try
            {
                ...
                DAL.Parameters.Add(new ParamStruct("@TINHTHANH_ID", DbType.Int32, clsCommon.GetValueDBNull(mvarTINHTHANH_ID), ParameterDirection.InputOutput, 4));
                DAL.Parameters.Add(new ParamStruct("@TINHTHANH_NAME", DbType.String, clsCommon.GetValueDBNull(mvarTINHTHANH_NAME), ParameterDirection.Input, 1000));
                DAL.Parameters.Add(new ParamStruct("@TINHTHANH_TYPE", DbType.String, clsCommon.GetValueDBNull(mvarTINHTHANH_TYPE), ParameterDirection.Input, 1000));
                ...
                mvarTINHTHANH_ID = Int32.Parse(clsCommon.GetValue(DAL.Parameters.Items("@TINHTHANH_ID").Value, mvarTINHTHANH_ID.GetType().FullName).ToString());

                return (mvarTINHTHANH_ID > 0);
            }
            catch (Exception ex)
            {
                return false;
        ...
        public bool Delete(int TINHTHANH_ID)
        {
            DataAccess DAL = m_DAL;
            try
            {
                ...
                DAL.Parameters.Add(new ParamStruct("@USERID", DbType.Int32, clsCommon.GetValueDBNull(mvarUSERID), ParameterDirection.Input, 4));
                DAL.Parameters.Add(new ParamStruct("@FREEPARA", DbType.String, clsCommon.GetValueDBNull(mvarFREEPARA), ParameterDirection.InputOutput, 1000));
                DAL.Parameters.Add(new ParamStruct("@TINHTHANH_ID", DbType.Int32, clsCommon.GetValueDBNull(TINHTHANH_ID), ParameterDirection.InputOutput, 4));
                return (DAL.ExecNonQuery() > 0);
            }
            catch (Exception ex)
            {
        ...
        public bool GetByKey(int TINHTHANH_ID)
        {
            DataAccess DAL = m_DAL;
            try
            {
        ...
        public void Reset()
        {
            ...
            mvarTINHTHANH_ID = Int32.MinValue;
            mvarTINHTHANH_NAME = string.Empty;
            mvarTINHTHANH_TYPE = string.Empty;
            mvarHOATDONG = false;
        ...
        public void FillData(DataRow row)
        {
            ...
            mvarTINHTHANH_ID = Int32.Parse(clsCommon.GetValue(row["TINHTHANH_ID"], mvarTINHTHANH_ID.GetType().FullName).ToString());
            mvarTINHTHANH_NAME = clsCommon.GetValue(row["TINHTHANH_NAME"], mvarTINHTHANH_NAME.GetType().FullName).ToString();
            mvarTINHTHANH_TYPE = clsCommon.GetValue(row["TINHTHANH_TYPE"], mvarTINHTHANH_TYPE.GetType().FullName).ToString();
