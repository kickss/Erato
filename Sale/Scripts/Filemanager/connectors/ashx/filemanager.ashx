...
public class filemanager : IHttpHandler 
{
    ...
    public void ProcessRequest (HttpContext context)
    {
        ...
        if (HttpContext.Current.Session["UIS_MemberTypeID"] == null || HttpContext.Current.Session["UIS_MemberTypeID"].ToString() == "1")
        {
            context.Response.Write("Khong co quyen thu thi");
            return;
        }
